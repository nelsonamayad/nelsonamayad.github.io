...
Por ejemplo, para el candidato Sergio Fajardo se utiliza el data frame *sf* y los priors $\small\mu_{candidato}=11$ y $\small\sigma_{candidato}=3$ en un objeto Stan de nombre *fajardo.stan*:
...
```
<br>
Para cerrar, los parámetros con [bayesplot](https://cran.r-project.org/web/packages/bayesplot/index.html)   
<br>
``` {r}
library(bayesplot)
posterior <- as.array(fajardo_fit)
