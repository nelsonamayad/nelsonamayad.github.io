...
$$\small\alpha_{encuestadora} \sim Normal(\mu, \sigma) $$
...
fajardo_fit <- stan(file='fajardo.stan',data=list(N=8,N_encuestadora=6,int_voto=sf$int_voto,encuestadora=sf$encuestadora, muestra_int_voto=sf$muestra_int_voto,m_error=sf$m_error,dd=sf$dd,tipo=sf$tipo),control=list(adapt_delta=0.9),iter=4000,chains=4)
```
<br>
