...
<br>
Encuestas utilizadas en el análisis: **13**
<br>
...
subtitle <- c("25 encuestas durante 2018, 13 desde las elecciones legislativas del 11 de marzo de 2018. \nCurva LOESS ponderada por el tamaño de la muestra de cada encuesta.")
fuente <- c("Fuente: Cálculos @nelsonamayad on base en las encuestas públicamente disponibles.")
