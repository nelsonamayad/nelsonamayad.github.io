...
subtitle <- c("30 encuestas durante 2018, 18 desde las elecciones legislativas del 11 de marzo de 2018 y resultado 27 de mayo. \nCurva LOESS ponderada por el tamaño de la muestra de cada encuesta.")
...
ggplot(df,aes(x=fecha, y=int_voto)) +
  ...
  #Resultado
  geom_hline(data=resultado,aes(yintercept=int_voto),linetype="dashed")
```
