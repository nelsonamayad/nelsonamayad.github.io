...
<br>
Última actualización: **06-06-2018** Bienvenidos a la 2da vuelta
<br>
...
```{r, echoe=FALSE,message=FALSE,fig.width = 6, fig.align = "center"}
library(RCurl)
library(tidyverse)
...
subtitle <- c("32 encuestas durante 2018, 2 desde la primera vuelta el 27 de mayo. \nCurva LOESS ponderada por el tamaño de la muestra de cada encuesta.")
