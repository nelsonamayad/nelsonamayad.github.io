...
1. [_**Entrada - Bogotá**_](https://nelsonamayad.shinyapps.io/bogota2019/): aplicación para ver las tendencias en la intención de voto para cada candidato de las elecciones de Bogotá según todas las encuestas públicamente disponibles. Preparada con [Shinyapps](https://www.shinyapps.io/).
