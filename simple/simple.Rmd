...
simple <- tribble(~candidato,~int_voto,~int_voto_max,~int_voto_min,~m_03.2018,
            "Sergio Fajardo",15.9,17.2,14.4,13.1,
            "Gustavo Petro",27.5,31.5,23.7,26.8,
            "Ivan Duque",40.4,43.2,37.5,38.1,
            "Humberto de la Calle",2.2,3.2,1,3,
            "German Vargas Lleras",6.7,7.9,5.6,6.6)
